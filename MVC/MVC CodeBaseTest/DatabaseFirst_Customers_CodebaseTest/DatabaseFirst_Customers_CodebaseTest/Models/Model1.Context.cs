...
namespace DatabaseFirst_Customers_CodebaseTest.Models
{
    using System;
    ...
    public partial class NorthwindDBContext : DbContext
    {
        ...
        public virtual int multiplication(Nullable<int> number)
        {
            var numberParameter = number.HasValue ?
                new ObjectParameter("number", number) :
                new ObjectParameter("number", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("multiplication", numberParameter);
        }
